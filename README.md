...
```
cd existing_repo
git remote add origin https://scm.platform.avalara.io/unm/camunda-client-go.git
git branch -M main
...
- [ ] [Set up project integrations](https://scm.platform.us-west-2.avalara.io/unm/camunda-client-go/-/settings/integrations)
